...
def LoadAllItems():
    ...
    Item(name="Cake", icon="🍰").AddToCategory("food")
    Item(name="Bobert", icon="🚮")
    Item(name="Ray", icon="🐈")
    Item(name="Ham", icon="🍖").AddToCategory("food")
    Item(name="Confetti", icon="🎊")
    Item(name="Candle", icon="🕯️")

    Item(name="Grapes", icon="🍇").AddToCategory("plants").AddToCategory("food")
    Item(name="Melon", icon="🍈").AddToCategory("plants").AddToCategory("food")
    Item(name="Watermelon", icon="🍉").AddToCategory("plants").AddToCategory("food")
    Item(name="Tangerine", icon="🍊").AddToCategory("plants").AddToCategory("food")
    Item(name="Lemon", icon="🍋").AddToCategory("plants").AddToCategory("food")
    Item(name="Banana", icon="🍌").AddToCategory("plants").AddToCategory("food")
    Item(name="Pineapple", icon="🍍").AddToCategory("plants").AddToCategory("food")
    Item(name="Mango", icon="🥭").AddToCategory("plants").AddToCategory("food")
    Item(name="Apple", icon="🍎").AddToCategory("plants").AddToCategory("food")
    Item(name="Green Apple", icon="🍏").AddToCategory("plants").AddToCategory("food")
    Item(name="Pear", icon="🍐").AddToCategory("plants").AddToCategory("food")
    Item(name="Peach", icon="🍑").AddToCategory("plants").AddToCategory("food")
    Item(name="Cherries", icon="🍒").AddToCategory("plants").AddToCategory("food")
    ...
    Item(name="Honey", icon="🍯").AddToCategory("bees").AddToCategory("food")
    ...
    Item(name="Baby Chick", icon="🐣").AddToCategory("food")
    Item(name="Duck", icon="🦆").AddToCategory("food")
    ...
    Item(name="Egg", icon="🥚").AddToCategory("food")
    Item(name="Cheese", icon="🧀").AddToCategory("food")
    Item(name="Pancakes", icon="🥞").AddToCategory("food")
    Item(name="Fries", icon="🍟").AddToCategory("food")
    Item(name="Hamburger", icon="🍔").AddToCategory("food")
    Item(name="Sushi", icon="🍣").AddToCategory("food")
    Item(name="Dumpling", icon="🥟").AddToCategory("food")
    Item(name="Can of Soup", icon="🥫").AddToCategory("food")
    ...
    Item(name="Medal", icon="🏅") .AddToCategory("material")
    ...
    Item(name="Scroll", icon="<:scroll:864727743206785045>", block=False).AddToCategory("material")
    Item(name="Soul Stone", icon="<:SoulStone:864725973379186688>", block=False).AddToCategory("material")
    Item(name="Purple Crystal", icon="<:PurpleCrystal:864725697833992222>", block=False).AddToCategory("material")
    Item(name="Health Potion", icon="<:healthpotion:864727727357427753>", block=False).AddToCategory("material")
    Item(name="Ember Insect", icon="<:emberedInsect:864725884212609054>", block=False).AddToCategory("material")
    ...
    Item(name="blood droplet", icon="🩸").AddToCategory("material")